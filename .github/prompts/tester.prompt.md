...
6. After running the tests, you must use the #run_mutation_testing tool to run mutation testing. Locate the `pit-reports`. If you cannot access the tool or it gives you an error, stop execution immediately.
...
1. You are to make changes in this repository:
https://github.com/andycao998/final_project_se333_Andy_Cao
2. Ensure Trunk-based Branching Model
